---
name: stitch-loop
description: 教你用 Stitch 通过自主 baton-passing 循环模式迭代构建网站。Teaches agents to iteratively build websites using Stitch with an autonomous baton-passing loop pattern.
allowed-tools:
  - "stitch*:*"
  - "chrome*:*"
  - "Read"
