...
description: 将 Stitch 设计转换为模块化的 Vite + React 组件，并结合系统级联网与 AST 校验保障结果可用。Converts Stitch designs into modular Vite and React components using system-level networking and AST-based validation.
allowed-tools:
  - "stitch*:*"
  - "Bash"
  - "Read"
