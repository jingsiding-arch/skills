---
name: remotion
description: 基于 Stitch 项目生成带平滑转场、缩放与文字覆盖的演示视频。Generate walkthrough videos from Stitch projects using Remotion with smooth transitions, zooming, and text overlays.
allowed-tools:
  - "stitch*:*"
  - "remotion*:*"
  - "Bash"
